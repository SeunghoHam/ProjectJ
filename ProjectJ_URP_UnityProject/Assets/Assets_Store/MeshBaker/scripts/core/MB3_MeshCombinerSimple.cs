...
#else
                    uvAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 2, vertsIdx, uv2s, uvsSliceIdx, meshChannelCache);
#endif
                }
...
#else
                    uvAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 3, vertsIdx, nuv3s, uvsSliceIdx, meshChannelCache);
#endif
...
#else
                    uvAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 4, vertsIdx, nuv4s, uvsSliceIdx, meshChannelCache);
#endif
...
#else
                    uvAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 5, vertsIdx, nuv5s, uvsSliceIdx, meshChannelCache);
#endif
...
#else
                    uvAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 6, vertsIdx, nuv6s, uvsSliceIdx, meshChannelCache);
#endif
...
#else
                    uvAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 7, vertsIdx, nuv7s, uvsSliceIdx, meshChannelCache);
#endif
...
#else
                    uvAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 8, vertsIdx, nuv8s, uvsSliceIdx, meshChannelCache);
#endif
...
#else
                uVAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 2, dgo.vertIdx, uv2s, uvsSliceIdx, meshChannelCache);
#endif
            }
...
#else
                Vector2[] nuv3 = meshChannelCache.GetUVChannel(3, mesh);
                uVAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 3, dgo.vertIdx, nuv3, uvsSliceIdx, meshChannelCache);
#endif
...
#else
                Vector2[] nuv4 = meshChannelCache.GetUVChannel(4, mesh);
                uVAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 4, dgo.vertIdx, nuv4, uvsSliceIdx, meshChannelCache);
#endif
...
#else
                Vector2[] nuv5 = meshChannelCache.GetUVChannel(5, mesh);
                uVAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 5, dgo.vertIdx, nuv5, uvsSliceIdx, meshChannelCache);
#endif
...
#else
                Vector2[] nuv6 = meshChannelCache.GetUVChannel(6, mesh);
                uVAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 6, dgo.vertIdx, nuv6, uvsSliceIdx, meshChannelCache);
#endif          
...
#else
                Vector2[] nuv7 = meshChannelCache.GetUVChannel(7, mesh);
                uVAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 7, dgo.vertIdx, nuv7, uvsSliceIdx, meshChannelCache);
#endif
...
#else
                Vector2[] nuv8 = meshChannelCache.GetUVChannel(8, mesh);
                uVAdjuster._copyAndAdjustUVsFromMesh(textureBakeResults, dgo, mesh, 8, dgo.vertIdx, nuv8, uvsSliceIdx, meshChannelCache);
#endif
